...
class ViewController: UIViewController {
    ...
    func formatRevealedWord() {
        ...
        for letter in wordToGuess {
            // check if letter in wordToGuess is in lettersGeussed (i.e. did you guess this letter already?)
...
//        }
        ...
        // check to see if you played all the words. If so, update the message indicating the player can restart the entire game.
    ...
    @IBAction func playAgainButtonPressed(_ sender: UIButton) {
        // if all words have been guessed and you've selected playAgain, then restart all games as if the app has been restarted
